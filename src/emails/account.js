...
function transporter() {
    return nodemailer.createTransport({
        service: 'gmail',
        auth: {
            user: 'halla.alhassan@gmail.com',  // Your email address
            pass: 'fzqrjanzieafoeoy' // Your password (or special app password)
        }
    })
}
...
function sendWelcomeEmail(email, name) {
    ...
    transporterObject.sendMail({
        from: 'Task Manager API <halla.alhassan@gmail.com>',
        to: email,
